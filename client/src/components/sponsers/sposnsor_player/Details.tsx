...
const Details = ({ row, setRow, name, code }: Props) => {
    const playerSponsorSlice = useSelector((state: { playerSponsorSlice: { loading: boolean, success: boolean, game: player_sponsor, error: string, games: obj[] } }) => state.playerSponsorSlice)
    const { loading, error, games, success } = playerSponsorSlice
