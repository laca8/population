...
import { addSponsor, editSponsor } from '../../../redux/slicers/sponsorSlicer'
...
const Add = ({ row }: Props) => {
    ...
    const sponsorSlice = useSelector((state: { sponsorSlice: { loading: boolean, game: sponsor, error: string, success: boolean, games: sponsor[] } }) => state.sponsorSlice)
    const { loading, error, success } = sponsorSlice
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        if (id === '' || name === '' || job === '' || manager === '' || address1 === '' || address2 === '' || phone1 === '' || phone2 === '' || notes === '') {
            ...
            <div >
                ...
                <div className='flex flex-col items-center text-zinc-900 border-2 border-yellow-600 p-2 text-center rounded-xl w-28 m-auto text-xl font-bold mb-4'>
                    <div className="flex gap-8 items-center">
                        ...
                        <h1 className='text-white text-center '>S<span className='text-yellow-500 '>p</span>onsor</h1>
                        <div className="animate-bounce">
