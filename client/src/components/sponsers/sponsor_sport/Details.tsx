...
import { removeSponsor, fetchSponsors } from '../../../redux/slicers/sportSponsor';
...
const Details = ({ row, setRow, name, code }: Props) => {
    const sportSponsorSlice = useSelector((state: { sportSponsorSlice: { loading: boolean, success: boolean, game: sport_sponsor, error: string, games: obj[] } }) => state.sportSponsorSlice)
    const { loading, error, games, success } = sportSponsorSlice
